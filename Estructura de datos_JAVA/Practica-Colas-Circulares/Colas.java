...
public class Colas extends javax.swing.JFrame {
    String[] Cola;
    int capacidad, frente=0, Final=0; 
...
public void eliminar() {
    if (!vacia()) {
        Cola[frente] = ""; // eliminar elemento
        frente++;          // avanzar frente
        visualizarCola();
    } else {
...
public void top() {
    if (!vacia()) {
        JOptionPane.showMessageDialog(null,
                "Elemento al frente: " + Cola[frente]);
    } else {
        JOptionPane.showMessageDialog(null, "La cola está vacía");
    }
}
...
public void sizeCola() {
    JOptionPane.showMessageDialog(null,
            "Número de elementos en la cola: " + (Final - frente));
}
    ...
    private void initComponents() {
        ...
        getContentPane().add(JCola, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 280, 310));
    ...
    private java.awt.TextArea JCola;
